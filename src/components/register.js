...
const Register = () => {
    ...
    /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/
        ...
        } else if(new Date(dob) >= new Date().setFullYear(new Date().getFullYear()-10))
        {
    ...
    return (
        <div className="container">
            <h1 style={{ display: 'flex' , justifyContent: 'center'}}>Student Registration</h1>
            <form className="mt-4">
                <div className="row">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                        ...
                        <input type="text" value={inpval.familyName} onChange={setdata} name="familyName" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                    </div>
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                    ...
                    <button type="submit" onClick={addinpdata} class="btn btn-primary" style={{ width: '100px' , marginLeft: '1030px' }}>Submit</button>
                </div>
            </form>
        </div>
    )
