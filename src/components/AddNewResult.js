    ...
    return (
        <div className="container">
            ...
            <form className="mt-4" onSubmit={addinpdata}>
                <div>
                    <select class="form-select" name='studentId' aria-label="studentId" onChange={setdata}>
                    ...
                    <select class="form-select" aria-label="courseId" name="courseId" onChange={setdata} style={{marginTop: '30px' }}>
                    ...
                    <select class="form-select" aria-label="score" name="score" onChange={setdata} value={inpval.score} style={{marginTop: '30px' }}>
                        {
                            scores.map((score) => {
                    ...
                    <button type='submit' class="btn btn-primary" style={{ width: '100px' , marginLeft: '1010px' ,marginTop: '30px' }}>Submit</button>
                </div>
            </form>
        </div>
    )
